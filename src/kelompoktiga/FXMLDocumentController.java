...
public class FXMLDocumentController implements Initializable {
    ...
    public void loginBtn() {
        ...
        if (si_username.getText().isEmpty() || si_password.getText().isEmpty()) {
            ...
            try {
                ...
                prepare = (PreparedStatement) connect.prepareStatement(selctData);
    ...
    public void regBtn() {
        ...
        if (su_username.getText().isEmpty() || su_password.getText().isEmpty()
            ...
            try {
                // PERIKSA APAKAH USERNAME SUDAH DIRECORD
                String checkUsername = "SELECT username FROM employee WHERE username = '"
                        + su_username.getText() + "'";

                prepare = (PreparedStatement) connect.prepareStatement(checkUsername);
                result = prepare.executeQuery();
                ...
                if (result.next()) {
                    ...
                    alert.setTitle("Error Message");
                    alert.setHeaderText(null);
                    alert.setContentText("Invalid password, must 8 characters!");
                    alert.showAndWait();
    ...
    private String[] questionList = {"What is your favorite color?", "What is your favorite food?", "What is your birth date?","What is the name of your childhood friend?","what's your pet's name"};
    ...
    // SWITCH TAB KETIKA LUPA PASSWORD
    ...
    // SWITCH FORM KETIKA INGIN REGISTRASI AKUN
